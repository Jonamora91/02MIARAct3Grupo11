\documentclass[11pt]{article}
    ...
    % Document parameters
    % Document title
    % Crear la portada sin añadir una página en blanco adicional
...
\PY{l+s+sd}{    Función que recibe una matriz (lista de listas) y calcula el determinante utilizando el método de pivoteo parcial.}
\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
    \PY{c+c1}{\PYZsh{} Convertir la matriz a tipo Fraction para mantener la precisión}
    \PY{c+c1}{\PYZsh{} Convertir la matriz a tipo Fraction para mantener la precisión}
    ...
    \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{n}\PY{p}{)}\PY{p}{:}
        \PY{c+c1}{\PYZsh{} Buscar el máximo en la columna actual desde la fila i hasta el final}
        ...
        \PY{k}{if} \PY{n}{max\PYZus{}valor\PYZus{}index} \PY{o}{!=} \PY{n}{i}\PY{p}{:}
            \PY{c+c1}{\PYZsh{} Se cambia la fila i por la del valor máximo}
        ...
        \PY{c+c1}{\PYZsh{} Eliminación por filas hacia adelante de manera vectorizada}
...
\PY{+w}{    }\PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}Función para formatear una fracción como texto \PYZsq{}num/den\PYZsq{}.\PYZdq{}\PYZdq{}\PYZdq{}}
...
\PY{c+c1}{\PYZsh{} Consideremos la siguiente matriz de dimensión 3x3:}
...
\PY{c+c1}{\PYZsh{} Convertir la matriz superior a formato de fracciones para impresión}
